...
(function () {
    ...
    Formalizer.prototype.createField = function (field_data, $scope, field_id) {
        ...
        var field_in_scope = "$formalizer.fields[" + field_id + "]['$$']",
            field_source = "$formalizer.fields[" + field_id + "].source";

        field = this.createFieldMeta(field_data, field_in_scope, field_id);
        this.__fields[field_id] = field;
        Object.defineProperty(this.fields[field_id], "$$", {
            value: field,
            writable : true,
            enumerable : false,
            configurable : false
        ...
        var html = template
                    ...
                    .replace(/%scope-field%/g, "$formalizer.fields[" + field_id + "]")
