...
function parseFields(definition, fields, new_fields,
    $scope, $element, $compile, $parse, $interpolate, callback) {
...
function formalizerController($scope, $element, $compile, $parse, $interpolate, $http, callback) {
  ...
  function($parse, $compile, $interpolate, $http) {
    ...
    return {
      ...
      controller: function($scope, $element, $compile) {
        return formalizerController($scope, $element, $compile, $parse, $interpolate, $http, function(arr) {
            fields_html = arr;
        });
      },
      compile: function() {
        ...
        */
        return {
          pre: function($scope, $element, $attrs) {
            var configuration = $scope.$eval($attrs.from);

            //if ("string" === typeof configuration.fields) {
            //    $scope.$watch(function(n, o) {
            //        var new_fields = [];
            //        parsed_fields = parseFields(n, parsed_fields, new_fields);
            //    });
            //} else {
            //    var new_fields = [];
            //    parsed_fields = parseFields(n, parsed_fields, new_fields);
            ...
            var fields = $scope.$eval(configuration.fields);
            var new_fields = [];

            parseFields(configuration, fields, new_fields,
